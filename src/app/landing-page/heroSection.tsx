...
const HeroSection = () => {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center bg-gradient-to-r from-blue-900 to-black overflow-hidden px-6 lg:px-0 min-h-screen">
      ...
      <div className="absolute top-10 left-6 z-50 flex items-center gap-2 cursor-pointer">
      <Link
  href="https://shahzadmirza.com/blog/"
  className="text-white mt-16 font-medium text-lg flex items-center gap-2 hover:text-orange-400 transition-all duration-300"
>
  <svg
  ...
  <span>My Blogs</span>
      ...
      <div className="absolute bottom-16 mt-24 w-full flex justify-between px-6 md:px-16 lg:px-32">
   
        <div className="bg-white text-blue-900 p-6 md:p-8 rounded-lg shadow-2xl w-72 md:w-80 text-center transition-transform duration-500 hover:scale-105 hover:-rotate-3 -rotate-3 mb-6">
